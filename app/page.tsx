...
const STEPS = [
  ...
  {
    duration: 'СБП · мгновенно',
    title: 'Оплата 9 999 ₽',
    body:
      'Оплачиваете по СБП с подтверждением операторa. После подтверждения — запускается анализ. Возврат, если отчёт не пришёл за 30 минут.',
  },
  {
    duration: '10 минут',
    title: 'Готовый отчёт на email',
    body:
      'Полный разбор: ваши слабые точки, что делают 4–6 конкурентов, 3 варианта УТП под сегменты, план на 30/60/90 дней. Каждый факт со ссылкой и оценкой достоверности.',
  },
] as const
...
const TARIFFS = [
  ...
  },
  {
    ...
    features: [
      '4–6 конкурентов в полном разборе с источниками',
      'Все ваши слабые точки (3–5) с привязкой к данным',
...
const FOUNDERS = [
  ...
  },
  {
    ...
    facts: [
      '35+ лет предпринимательского стажа',
...
const COMPARISON = [
  ...
  },
  {
    label: 'Цена',
    them: 'от 60 000 ₽',
    us: '9 999 ₽ (фиксированная)',
  },
  {
    label: 'Источники фактов',
    them: 'Опыт консультанта',
    us: 'Каждый факт со ссылкой, датой и RS-оценкой',
  },
  {
