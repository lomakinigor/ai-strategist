...
- directions: string[] — направления деятельности (виды услуг / продуктовых категорий / практик). ОБЯЗАТЕЛЬНО раздели на отдельные элементы массива, если в тексте перечислены 2+ ВИДА услуг или практик. НЕ объединяй разные практики в один обобщающий пункт ради краткости. Примеры разбиения по нишам:
   * Юридическая компания: «Взыскание задолженности», «Налоговые споры», «Субсидиарная ответственность», «Корпоративные споры», «Банкротство», «Защита от необоснованных претензий», «Возврат денежных средств по договорам займа» — это РАЗНЫЕ направления, даже если все «для бизнеса». КАЖДОЕ — отдельный элемент массива.
   * Производство: «Производство оборудования», «Сервисное обслуживание», «Поставка запчастей» — РАЗНЫЕ элементы.
   * IT-агентство: «Разработка сайтов», «Маркетинг», «SEO», «Дизайн» — РАЗНЫЕ элементы.
   * E-commerce: каждая ТОВАРНАЯ категория или линейка — отдельный элемент.
   Если бизнес работает в одной нише с одним продуктом и в тексте только один вид деятельности — один элемент массива.
