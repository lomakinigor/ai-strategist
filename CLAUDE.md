...
- Суммы — в рублях
- Весь UI, включая admin, reports, dialogs и print, следует [docs/brand/DESIGN.md](docs/brand/DESIGN.md); оригинал — [docs/brand/ai-brand-book-pomelli.pdf](docs/brand/ai-brand-book-pomelli.pdf)
