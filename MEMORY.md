...
| 2026-08-11 | Повторные mobile word-wrap регрессии проверяются через `/mobile-word-wrap-audit` | Skill фиксирует TDD-контракт и browser-проверку неделимых русских слов на 320–412 px |
