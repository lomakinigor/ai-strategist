...
const RESEARCH_PROMPTS: Record<ResearchType, (q: ResearchRequest['query']) => string> = {
  business: (q) =>
    ...
    ` Нужно: описание бизнес-модели и основных продуктов/услуг, позиционирование, ключевые конкуренты, упоминания в деловых СМИ РФ.` +
    ` Приоритет источникам: официальный сайт компании, ЕГРЮЛ, РБК, Ведомости, Коммерсант.`,

  market: (q) =>
    `Анализ рынка отрасли «${q.industry}» в России, актуальные данные за 2024–2025 год.` +
